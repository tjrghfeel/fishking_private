          ...
          <React.Fragment>
            ...
            <div className="container nopadding">
              <div className="pt-0">
                ...
                <hr className="full mt-3 mb-3" />
                <a
                  onClick={() => PageStore.push(`/common/set/profile/nickname`)}
                >
                  <div className="row no-gutters align-items-center">
                    <div className="col-3 pl-2">
                ...
                <hr className="full mt-3 mb-3" />
                <a onClick={() => PageStore.push(`/common/set/profile/status`)}>
                  <div className="row no-gutters align-items-center">
                    <div className="col-3 pl-2">
                ...
                <hr className="full mt-3 mb-3" />
                <a onClick={() => PageStore.push(`/common/set/profile/email`)}>
                  <div className="row no-gutters align-items-center">
                    <div className="col-3 pl-2">
                ...
                <hr className="full mt-3 mb-3" />
                <a
                  onClick={() => PageStore.push(`/common/set/profile/password`)}
                >
                  <div className="row no-gutters align-items-center">
                    <div className="col-3 pl-2">
