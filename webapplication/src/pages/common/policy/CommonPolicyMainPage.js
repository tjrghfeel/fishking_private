    ...
    class extends React.Component {
      ...
      render() {
        ...
        return (
          <React.Fragment>
            {/** Navigation */}
            <Navigation title={"약관 및 정책"} showBackIcon={true} />

            <div className="container nopadding mt-0">
              <div className="pt-0">
                <hr className="full mt-0 mb-3" />
                <a onClick={() => PageStore.push(`/common/policy/terms`)}>
                ...
                <a onClick={() => PageStore.push(`/common/policy/privacy`)}>
                  <div className="row no-gutters align-items-center">
                ...
                <hr className="full mt-3 mb-3" />
                <a onClick={() => PageStore.push(`/common/policy/cancel`)}>
                  <div className="row no-gutters align-items-center">
                ...
                <hr className="full mt-3 mb-3" />
                <a onClick={() => PageStore.push(`/common/policy/lbs`)}>
                  <div className="row no-gutters align-items-center">
                ...
                <hr className="full mt-3 mb-3" />
                <a onClick={() => PageStore.push(`/common/policy/agree`)}>
                  <div className="row no-gutters align-items-center">
