    ...
    return (
      <>
        ...
        <div className="container nopadding mt-4">
          ...
          <div className="card-round-box-grey mt-3 pt-3 pb-3">
            <ul className="list">
              <li>
                ...
                가입정보 등 그 외 사용자가 설정한 모든 정보가 사라지고 복구가
                불가능합니다.
              </li>
              <li>
                참여중인 댓글 및 사진 정보 등 모든 정보가 즉시 삭제되므로 중요한
                정보가 있는지 탈퇴 전에 저장해 주세요.
              </li>
              <li>탈퇴 시 어복황제에 재가입해도 자동으로 복구되지 않습니다.</li>
            </ul>
          </div>
          <label className="control radio mt-2">
            <input type="radio" className="add-contrast" data-role="collar" />
          ...
          <br />
          <a href="login.html" className="btn btn-primary btn-lg btn-block">
            탈퇴하기
          </a>
        </div>
      </>
