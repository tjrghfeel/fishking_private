        ...
        <div className="container nopadding mt-0">
          <div className="padding policy">
              ...
              <tbody>
                ...
                <tr>
                  <td>
                    ...
                    포인트 결제, 세이브 서비스 이용, 기타 카드 (기프트, 포인트,
                    선불, 법인, 해외), 최초 결제일로부터 3개월 경과 시
                  </td>
                </tr>
              </tbody>
            </table>
            ...
            <ul className="list">
              ...
              <li>
                예약 상품 별 예약정보에 기재된 취소, 환불 규정을 반드시 확인 후
                이용해주시기 바랍니다.
              </li>
              ...
              <li>
                전월 휴대폰 결제 건은 단순 변심의 사유로 예약 취소할 경우, 취소
                규정 외에 환불 수수료 5%가 발생합니다.
              </li>
              <li>
                예약 취소가 불가능한 시간에 고객 사정에 의한 취소 시, 어복황제가
                제공하는 모든 혜택에서 제외될 수 있으며(할인 쿠폰 미제공, 이벤트
                대상자 제외, 혜택받기 포인트 미지급), 본 예약 시 사용한 쿠폰은
                소멸됩니다.
              </li>
              <li>
              ...
              <li>
                구매 취소 시점과 해당 카드사의 환불 처리기준에 따라 취소금액의
                환급 방법과 환급일은 다소 차이가 있을 수 있으며, 사용한
                신용카드의 환불 정책은 신용카드회사에 직접 문의하여야 합니다.
              </li>
              <li>
                개별 "상품 등"의 성격에 따라 "회사"는 별도 계약 및 이용조건에
                따른 구매취소 및 청약철회 관련 규정을 정할 수 있으며 이 경우
                별도 계약 및 이용조건상의 구매취소 및 청약철회 규정이 우선
                적용됩니다.
              </li>
              <li>
              ...
              <li>
                업체의 사정으로 상세 정보가 수시로 변경될 수 있으며, 이로 인한
