...
export default inject()(
  observer(() => {
    return (
      <>
        {/** Navigation */}
        <Navigation title={"위치기반 서비스 이용약관"} visibleBackIcon={true} />
        ...
        <div className="container nopadding mt-0">
          <div className="padding policy">
            ...
            <p>
              본 약관은 회원(어복황제 서비스 약관에 동의한 자를 말합니다. 이하
              "회원"이라고 합니다.) 이 주식회사 투비(이하 "회사"라고 합니다.)가
              제공하는 어복황제 서비스(이하 "서비스"라고 합니다)를 이용함에 있어
            ...
            <p>
              ...
              공지ㆍ고지일로부터 개정약관 시행일 7일 후까지 거부의사를 표시하지
              아니하면 이용약관에 승인한 것으로 봅니다. 회원이 개정약관에
            ...
            <table className="table table-bordered">
              ...
              <tr>
                ...
                <td style={{ textAlign: "center" }}>
                  위치정보수집 대상의 실시간 위치 확인이용자의 위치에서 근접한
                  업소정보제공
                </td>
              </tr>
            </table>
            ...
            <p>
              ① 회사가 제공하는 서비스는 기본적으로 무료입니다. 단, 별도의 유료
              서비스의 경우 해당 서비스에 명시된 요금을 지불하여야 사용
              가능합니다.
              <br />
            ...
            <p>
              ...
              경우에는 개인위치정보를 수집한 당해 통신 단말장치로 매회 회원 에게
              제공받는 자, 제공 일시 및 제공목적을 즉시 통보합니다. 단, 아래 각
              호의 1에 해당하는 경우에는 회원이 미리 특정하여 지정한 통신
            ...
            <p>
              ...
              이용하거나 제3자에게 제공하고자 하는 경우에는 14세 미만의 아동과
              그 법정대리인의 동의를 받아야 합니다. 단, 아래의 경우는
              제외합니다.
              <br />
              <div className="indent">
            ...
            <p>
              ...
              <div className="indent">
                ...
                2. 금치산자
                <br />
                3. 장애인복지법제2조제2항제2호의 규정에 의한 정신적 장애를 가진
            ...
            <p>
              ...
              회사에 대하여 손해배상 청구를 할 수 있습니다. 이 경우 회사는 고의,
              과실이 없음을 입증하지 못하는 경우 책임을 면할 수 없습니다.
              <br />② 회원이 본 약관의 규정을 위반하여 회사에 손해가 발생한 경우
              회사는 회원에 대하여 손해배상을 청구할 수 있습니다. 이 경우 회원은
            ...
            <h6>제 15 조 (규정의 준용) </h6>
            <p>
              ① 본 약관은 대한민국법령에 의하여 규정되고 이행됩니다. <br />② 본
              약관에 규정되지 않은 사항에 대해서는 관련법령 및 상관습에
              의합니다.
            </p>
            <p className="clearfix"></p>
            ...
            <p>
              ...
              있습니다. <br />② 회사 또는 고객은 위치정보와 관련된 분쟁에 대해
            ...
            <h6>부 칙 </h6>
            <h6>제1조 (시행일) </h6>
            <p>이 약관은 201X년 00월 00일 부터 시행한다.</p>
            <p className="clearfix"></p>

            <h6>제2조 </h6>
            <p>
              위치정보관리책임자는 201X년 00월 00일 을 기준으로 다음과 같이
              지정합니다. <br />
              1. 소 속 : <br />
              2. 연 락 처 :
            </p>
