...
export default inject("NativeStore")(
  observer(({ NativeStore }) => {
    return (
      <>
        {/** Navigation */}
        <Navigation title={"개인정보처리방침"} showBack={true} />
        ...
        <div className="container nopadding mt-0">
          <div className="padding policy">
            <p>
              ...
              조치가 취해지고 있는지 알려드립니다. 개인정보처리방침은 이용자가
              언제나 쉽게 열람 할 수 있도록 서비스 초기화면을 통해 공개하고
              있으며, 개인정보 관련법령, 지침, 고시 또는 어복황제 서비스 정책의
              변경에 따라 달라질 수 있습니다.
            </p>
            ...
            <p>
              ...
              개인정보는 다음의 수집·이용목적 이외의 용도로는 활용되지 않으며,
              수집·이용목적이 변경되는 경우에는 개인정보보호법에 따라 별도의
            ...
            <table className="table table-bordered">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    아이디(전자우편주소), 이름, 닉네임, 비밀번호, 휴대전화번호
                  </td>
                  <td rowSpan="3">
                    회원탈퇴 후 지체 없이 파기 (단 관련법령 및 회사 정책에 따라
                    별도 보관되는 정보는 예외)
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    브라우저 정보, 이용콘텐츠, 서비스 이용에 대한 플랫폼 구분에
                    따른 OS, 사용된 신용카드정보, 관심지역
                  </td>
                ...
                <tr>
                  ...
                  <td rowSpan="2">
                    전자상거래 등에서의 소비자보호에 관한 법률에 따라 5년간 보관
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    마케팅 정보 안내를 위한 목적으로 1년 보관 이벤트 진행 관련
                    안내 및 당첨자 선정을 위해 최대 1년 보관(이벤트 마다 상이할
                    수 있으며, 개별 이벤트 페이지에 기재된 기간을 우선합니다.)
                  </td>
                </tr>
              </tbody>
            </table>
            ...
            <p>
              ...
              비밀유지, 제3자 제공의 금지 및 사고시의 책임부담, 위탁기간, 처리
              종료 후의 개인정보의 반환 또는 파기 등을 명확히 규정하고 당해
              계약내용을 서면 등 전자적형태로 보관하겠습니다.
              <br />⑶ 회사의 개인정보 위탁처리 기관 및 위탁업무 내용은 아래와
              같습니다.
            </p>
            <p className="clearfix"></p>
            ...
            <table className="table table-bordered">
              ...
              <tbody>
                <tr>
                  <td></td>
                  <td style={{ textAlign: "center" }}>
                    휴대폰, 신용카드, 계좌이체, 무통장입금(가상계좌) 등을 통한
                    결제처리
                  </td>
                  <td style={{ textAlign: "center" }}>
                    위탁 계약 만료 시 까지 보유
            ...
            <p>
              ⑴ 파기절차 : 회원님이 문의 글 등록을 위해 입력하신 정보는 목적이
              ...
              재생할 수 없는 기술적 방법을 사용하여 삭제합니다. 종이에 출력된
            ...
            <p>
              ...
              절차와 방법에 따라 수사기관의 요구가 있을 경우 회원님의 개인정보를
              제공할 수 있습니다.
              <br />⑷ 서비스 이용 시 제 3자 제공에 동의한 경우 해당 서비스 제공
              업체에게 아래의 개인정보가 제공됩니다.
            </p>
            <p className="clearfix"></p>
            ...
            <table className="table table-bordered">
              ...
              <tbody>
                <tr>
                  ...
                  <td style={{ textAlign: "center" }}>이벤트 당첨자 해피콜</td>
                  <td style={{ textAlign: "center" }}>이름, 전화번호, 주소</td>
                  <td style={{ textAlign: "center" }}>
                    재화 또는 서비스의
                    <br /> 제공 목적이 달성 된 후 파기
                  </td>
                ...
                <tr>
                  ...
                  <td style={{ textAlign: "center" }}>
                    ...
                    <br />
                    (예약자 이름, 휴대폰번호, 예약자 안심번호, 예약번호, 예약한
                    업체명, 예약한 상품명, 결제금액)
                  </td>
                  <td style={{ textAlign: "center" }}>
            ...
            <p>
              (5) 다음의 경우에는 예외적으로 고객의 동의 없이 개인정보를 제공할
              수 있습니다.
              <br />
              - 관계법령에 의하여 수사상의 목적으로 공공기관으로부터의 요구가
              있을 경우
              <br />
              ...
              요청에 의해 정보를 제공한 경우에는 본래의 수집목적 및 이용목적에
              반하여 무분별하게 정보가 제공되지 않도록 최대한 노력하겠습니다.
            </p>
            <p className="clearfix"></p>

            <h4>6. 비회원 고객의 개인정보수집 및 보호</h4>
            <p>
              ⑴ 회사에서는 회원뿐만 아니라 비회원 또한 상품예약 및 구매를 하실
              수 있습니다. 회사는 비회원 예약 및 구매의 경우 대금 결제에 반드시
              필요한 개인정보 만을 요청하고 있습니다. 회사에서 비회원으로 구매를
              하신 경우 비회원 고객께서 입력하신 지불인 정보는 대금 결제 및
              서비스 이용에 관련한 용도 외에는 다른 어떠한 용도로도 사용되지
              않습니다.
            </p>
            <p className="clearfix"></p>

            <h4>
              7. 이용자 및 법정 대리인은 언제든지 등록되어 있는 자신 혹은 당해
              만 14세 미만 아동의 개인정보를 조회하거나 수정할 수 있으며 가입
              해지를 요청할 수도 있습니다.
            </h4>
            <p>
              ...
              제3자에게 지체없이 통지하여 정정이 이루어지도록 하겠습니다. 이용자
              혹은 법정 대리인의 요청에 의해 해지 또는 삭제된 개인정보는 회사가
            ...
            <h4>
              8. 회사는 귀하의 정보를 수시로 저장하고 찾아내는 ‘쿠키(cookie)’
              등을 운용합니다. 쿠키란 어복황제를 운영하는데 이용되는 서버가
            ...
            <p>
              ...
              서비스 제공 귀하는 쿠키 설치에 대한 선택권을 가지고 있습니다.
              따라서, 귀하는 웹브라우저 에서 옵션을 설정함으로써 모든 쿠키를
              허용하거나, 쿠키가 저장될 때마다 확인을 거치거나, 아니면 모든
              쿠키의 저장을 거부할 수도 있습니다.
              <br />⑵ 쿠키 설정 거부 방법 : 쿠키 설정을 거부하는 방법으로는
              회원님이 사용하시는 웹 브라우저의 옵션을 선택함으로써 모든 쿠키를
              허용하거나 쿠키를 저장할 때마다 확인을 거치거나, 모든 쿠키의
              저장을 거부할 수 있습니다. 단, 귀하께서 쿠키 설치를 거부하였을
            ...
            <h4>
              ...
              충분한 답변을 드릴 것입니다. 기타 개인정보침해에 대한 신고나
            ...
            <p>
              ...
              <br />- 정보보호마크인증위원회 (
              <a
                onClick={() => NativeStore.linking("http://www.eprivacy.or.kr")}
                className="point"
              >
                www.eprivacy.or.kr
              </a>{" "}
