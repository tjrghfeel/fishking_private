          ...
          <div className="container nopadding">
            <nav className="nav nav-pills nav-tab nav-justified">
              <a
                ...
                onClick={() => PageStore.push(`/police/main/home`)}
              >
                <figure className="tab_home"></figure>홈
              </a>
              <a
                className={"nav-link" + (activeIndex === 1 ? " active" : "")}
                onClick={() => PageStore.push(`/police/main/boat`)}
              >
              ...
              <a
                ...
                onClick={() => PageStore.push(`/police/main/rock`)}
              >
              ...
              <a
                ...
                onClick={() => PageStore.push(`/police/main/story/diary`)}
              >
              ...
              <a
                ...
                onClick={() => PageStore.push(`/police/main/my`)}
              >
