        ...
        withRouter(
            class extends React.Component {
                ...
                loadPageData = async () => {
                    ...
                    //     // this.weatherIframe.current.contentDocument.location.reload(true)
                    //     document.getElementById("weatherIframe").contentDocument.location.reload(true)
                    // })
                                    ...
                                    <div className="shipDetail-weather">
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                (this.state.weather.windDirection + " " + this.state.weather.windSpeed)} m/s</td>
                                            </tr>
                                        </table>
                                    </div>
                                </ul>
