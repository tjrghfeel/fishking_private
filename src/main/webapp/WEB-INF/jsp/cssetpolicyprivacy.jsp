...
<div class="container nopadding mt-0">
    <div class="padding policy">
        <p>주식회사 투비 (이하 '회사')는 고객님의 개인정보를 중요시하며, "정보통신망 이용촉진 및 정보보호"에 관한 법률을 준수하고 있습니다. 회사는 개인정보취급방침을 통하여 고객님께서 제공하시는 개인정보가 어떠한 용도와 방식으로 이용되고 있으며, 개인정보보호를 위해 어떠한 조치가 취해지고 있는지 알려드립니다.
            개인정보처리방침은 이용자가 언제나 쉽게 열람 할 수 있도록 서비스 초기화면을 통해 공개하고 있으며, 개인정보 관련법령, 지침, 고시 또는 어복황제 서비스 정책의 변경에 따라 달라질 수 있습니다.</p>
        <p class="clearfix"></p>
        ...
        <p>회사는 편리하고 더 나은 서비스를 제공하기 위해 업무 중 일부를 외부에 위탁하고 있습니다.<br/>
            ⑴ 개인정보의 처리를 위탁하는 경우에는 위탁기관 및 그 사실을 어복황제 어플리케이션을 통해 미리 고지하겠습니다.<br/>
        ...
        <table class="table table-bordered">
            ...
            <tr>
                <td style="text-align:center">어복황제 상품예약 및 구매 서비스 제공 업체[업체 리스트]</td>
                <td style="text-align:center">어복황제 상품예약 및 구매 서비스 이용계약 이행<br/>(서비스 제공, 확인, 이용자 정보 확인)</td>
        ...
        <h4>8. 회사는 귀하의 정보를 수시로 저장하고 찾아내는 ‘쿠키(cookie)’ 등을 운용합니다. 쿠키란 어복황제를 운영하는데 이용되는 서버가 귀하의 브라우저에 보내는 아주 작은 텍스트 파일로서 귀하의 컴퓨터 하드디스크에 저장됩니다. 회사는 다음과 같은 목적을 위해 쿠키를 사용합니다.</h4>
        <p>
        ...
        <table class="table table-bordered">
            ...
            <tr>
                <th>개인정보보호 전담담당부서</th>
                <td>소속: 어복황제 플랫폼개발팀<br/> 성명<br/>연락처:<br/>이메일:	</td>
            </tr>
            </tbody>
        </table>
