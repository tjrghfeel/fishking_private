...
<nav class="navbar fixed-top navbar-dark bg-primary">
    ...
    <span class="navbar-title">위치기반 서비스 이용약관</span>
</nav>
<!-- // Navigation -->
...
<div class="container nopadding mt-0">
    <div class="padding policy">
        ...
        <p>본 약관은 회원(어복황제 서비스 약관에 동의한 자를 말합니다. 이하 "회원"이라고 합니다.) 이 주식회사 투비(이하 "회사"라고 합니다.)가 제공하는 어복황제 서비스(이하 "서비스"라고 합니다)를 이용함에 있어 회사와 회원의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.</p>
        <p class="clearfix"></p>
        ...
        <table class="table table-bordered">
            ...
            <tr>
                <td style="text-align:center">어복황제 서비스</td>
                <td style="text-align:center">위치정보수집 대상의 실시간 위치 확인이용자의 위치에서 근접한 업소정보제공</td>
            </tr>
        </table>
        <p class="clearfix"></p>
        ...
        <h6>제 17 조 (회사의 연락처) 회사의 상호 및 주소 등은 다음과 같습니다.       </h6>
        <p>
            1. 상     호 :    <br/>
            2. 대 표 자 :<br/>
            3. 주     소 : <br/>
        ...
        <h6>제2조        </h6>
        <p>
            위치정보관리책임자는 201X년 00월 00일 을 기준으로 다음과 같이 지정합니다.  <br/>
            1. 소     속 :  <br/>
            2. 연 락 처 :
        </p>
