...
@Entity
@AllArgsConstructor
@Table(name = "camera_point_realtime_video")
public class CameraPointRealTimeVideo {
    ...
    @ManyToOne
    @JoinColumn(name="rtvideos_camera_point_id" , columnDefinition = "bigint  NOT NULL   comment '카메라 포인트'")
    ...
    @Column(columnDefinition = "varchar(500) comment '토큰' ")
    ...
    @Builder
    public CameraPointRealTimeVideo(Integer rNo, Member member, CameraPoint cameraPoint, String name, String serial,
                                    String token, String expireTime, String type) {
        this.rNo = rNo;
