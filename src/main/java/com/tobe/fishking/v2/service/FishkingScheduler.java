...
//
    ...
    public void completeFishing() {
        ...
        List<Orders> orders = ordersRepository.getOrderByStatusForScheduler(date, time, OrderStatus.bookFix);
        for (Orders order : orders) {
            order.changeStatus(OrderStatus.fishingComplete);
        }
