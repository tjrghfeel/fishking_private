...
public class ReviewController {
    ...
    @ApiOperation(value = "리뷰 작성",notes = "" +
            ...
            "- fishingDate : String / 필수 / 예약건에 들어있는 낚시일자. 'yyyyMMdd' 형식으로 입력. \n" +
    ...
    /*리뷰수정*/
    @ApiOperation(value = "리뷰 수정",notes = "" +
            "요청 필드 ) \n" +
            "- reviewId : Long / 필수 / 수정하려는 리뷰의 id\n" +
            "- cleanScore : Double / 필수 / 청결도 점수 / 0~5점\n" +
            "- serviceScore : Double / 필수 / 서비스 점수 / 0~5점\n" +
            "- tasteScore : Double / 필수 / 손맛 점수 / 0~5점\n" +
            "- content : String / 필수 / 내용 / 5자~1000자 \n" +
            ...
            "응답 필드 ) 수정 성공시 true. \n")
    @PutMapping("/review")
    public Boolean modifyReview(@RequestBody @Valid ModifyReviewDto dto, @RequestHeader("Authorization") String token) throws ResourceNotFoundException {
        return reviewService.modifyReview(dto, token);
    }
